...
class _ReportsPageState extends State<ReportsPage> {
  ...
  // --- COMPREHENSIVE PDF GENERATOR ENGINE ---
  Future<void> _exportDocumentReport({
    required List<QueryDocumentSnapshot> transactions,
  }) async {
    try {
      // Capture structural charts as image data buffers
        ...
        pw.MultiPage(
          ...
          build: (pw.Context context) {
            return [
              ...
              // Embedded Captured Visuals Section Row
              ...
              // Transaction Log Data Table Section Block
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      // Ordering by server timestamp descending guarantees your last inventory modifications hit the top of the stream list
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                        ...
                        children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(color: navNavy.withValues(alpha: 0.5), blurRadius: 16, offset: const Offset(0, 6)),
                              ],
                            ),
                            child: Material(
                                            ...
                                            getTitlesWidget: (value, meta) {
                                              ...
                                              if (value.toInt() >= 0 && value.toInt() < categories.length) {
                                                return Padding(
                                                  ...
                                                  child: Text(categories[value.toInt()], style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
                                                );
                                              }
                                              return const Text('');
                                            },
                  ...
                  // Live Transaction History Feed Table Layout Card
                  Container(
                    decoration: BoxDecoration(
                      color: Colors.white,
  ...
  Widget _buildSummaryCard(String title, String count, IconData icon, Color color, Color bgColor) {
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(16), border: Border.all(color: Colors.grey.shade300, width: 1), boxShadow: const [BoxShadow(color: Colors.black12, blurRadius: 20, offset: Offset(0, 8))]),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
